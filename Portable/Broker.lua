...
function me:CreateUI_Broker()
	...
	me.broker.header.text:SetFont("Fonts\\ARIALN.TTF", 14, "")
	...
	for n = 1, me.MAX_BUTTONS do
		...
		me.broker[button].text:SetFont("Fonts\\ARIALN.TTF", 12, "")	-- Default font, we don't want a nil font
	...
	me.broker.info.text:SetFont("Fonts\\ARIALN.TTF", 10, "")
