...
L["Old Silvermoon City"] = "Altes Silbermond"
...
L["Show Minimap Icon (Mage only)"] = "Zeige Minimap-Symbol (nur Magier)"
L["Shows the Portable minimap icon. Only visible for Mages."] = "Zeigt das Portable-Minimap-Symbol an. Nur für Magier sichtbar."
...
L["Behaviour of the Button Name Text."] = "Verhalten des Tasten namen textes."
L["Border Artwork"] = "Grenzgrafik"
L["Border Artwork of the Simple Frame Style.\\n|cffffff00Note, only for the Simple Frame style|r."] = "Rahmengrafik des einfachen Rahmenstils.\\n|cffffff00Beachte, nur für den Simple Frame-Stil|r."
...
L["Show Map Pins"] = "Karten-Pins anzeigen"
